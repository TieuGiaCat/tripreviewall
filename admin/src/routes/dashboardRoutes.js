  ...
  const body = `
    ...
    <div class="form-card">
      ...
      <p style="color:var(--color-text-muted);line-height:1.6;">
        Every module in the sidebar is now built: Tours, Blog Posts, Leads, Destinations,
        Authors, Media Library, Settings (Email + Tracking), Analytics and Users all have
        full CRUD/management where relevant.
      </p>
    </div>
  `;
