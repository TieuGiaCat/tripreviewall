...
const BLOG_POSTS_FALLBACK = [
  {
    ...
    body: "<p>Self-driving the Road to Hana is usually framed as the free option, since you're not paying a tour operator. That's only true if you ignore three costs most people forget to add up: the rental car itself, gas for roughly 120 miles of low-speed mountain driving, and the day you lose to driving instead of looking at anything.</p><p>A compact rental for the day typically runs $70 to $110 depending on season, plus another $25 to $35 in gas given how much of the drive is in low gear. That alone puts a rental day in a similar range to a mid-priced guided tour before accounting for the time cost of navigating 620 curves and 59 one-lane bridges yourself.</p><p>Guided Road to Hana tours on Maui range from van-based group tours to fully private departures, generally scaling with group size and flexibility.</p><p>For a first Hana trip, the guided option is usually the better value once fatigue and lost sightseeing time are counted. Returning visitors who already know the route are the exception — for them, self-driving still makes sense.</p>",
    readTime: 7,
  ...
  },
  {
    ...
    body: "<p>Sample fallback content — replace by publishing a real post in Admin.</p>",
    readTime: 6,
    tags: [],
    disclosureText: "",
